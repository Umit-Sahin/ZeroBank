...
public class AccountSummaryStepDefs {
    ...
    public void account_summary_page_should_have_to_following(String accountTypes) {
        AccountSummary accountSummary= new AccountSummary();
        List<String > actualAccounts = Utils.getElementsText(accountSummary.headerAccounts);
    ...
    public void credit_Accounts_table_must_have(String columns) {
        AccountSummary accountSummary= new AccountSummary();
        List<String> actualColumns = Utils.getElementsText(accountSummary.creditAccounts);
